...
const nizLinkovaStranica = ["/index.html",`${prefiksPage}usluge.html`,`${prefiksPage}meni.html`,`${prefiksPage}saveti.html`,`${prefiksPage}kontakt.html`,`${prefiksPage}autor.html`];
